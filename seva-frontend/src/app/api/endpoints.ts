export const endpoint = {
  ...
  whatsapp: {
    ...
    deleteCampaign: (id: string) => `/marketing/campaigns/${id}`,
    startCampaign: (id: string) => `/marketing/campaigns/${id}/start`,
    pauseCampaign: (id: string) => `/marketing/campaigns/${id}/pause`,
    resumeCampaign: (id: string) => `/marketing/campaigns/${id}/resume`,
    retryFailed: (id: string) => `/marketing/campaigns/${id}/retry-failed`,
    getTemplates: "/marketing/templates",
    getTemplateById: (id: string) => `/marketing/templates/${id}`,
    createTemplate: "/marketing/templates",
    updateTemplate: (id: string) => `/marketing/templates/${id}`,
    deleteTemplate: (id: string) => `/marketing/templates/${id}`,
    seedTemplates: "/marketing/templates/seed",
    getConfig: "/marketing/config",
    updateConfig: "/marketing/config",
    getBaileysStatus: "/marketing/baileys/status",
    reconnectBaileys: "/marketing/baileys/reconnect",
    disconnectBaileys: "/marketing/baileys/disconnect",
    testOfficialApi: "/marketing/official/test",
    sendTest: "/marketing/send-test",
    uploadExcel: "/marketing/upload-excel",
    sampleExcel: "/marketing/sample-excel",
    getLogs: "/marketing/logs",
  },
};