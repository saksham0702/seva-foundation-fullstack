...
export default function InitiativeCard({
  ...
  const scrollToDonationForm = () => {
    const el = document.getElementById("initiative-donation-form");
    if (el) {
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                className="p-3 rounded-full bg-slate-50 hover:bg-slate-100 text-slate-700 transition-colors border border-slate-200 flex-shrink-0 cursor-pointer"
              >
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="flex flex-wrap gap-3 pt-4">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-[#F5A623] hover:bg-[#e0951a] text-white font-semibold text-sm transition-all shadow-md shadow-amber-500/20 cursor-pointer"
              >
              ...
              <button
                type="button"
                onClick={() => setIsShareModalOpen(true)}
                className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl border border-slate-300 hover:border-slate-800 text-slate-800 font-semibold text-sm transition-colors bg-white hover:bg-slate-50 cursor-pointer"
              >
                <Share2 size={16} className="text-[#4C6FFF]" />
